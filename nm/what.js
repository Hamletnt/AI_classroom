...
// document.querySelector('.overlap-2').addEventListener('click', function() {
//     let currentImageSrc = document.getElementById('currentImage').src;
//     window.location.href = 'what2.html?image=' + encodeURIComponent(currentImageSrc); // ส่งค่า URL ของรูปไปยัง what2.html
// });

// document.addEventListener("DOMContentLoaded", function() {
//     let params = new URLSearchParams(window.location.search); // ดึง URL parameters
//     let imageSrc = params.get('image'); // ดึงค่าของ 'image' จาก URL
  
//     if (imageSrc) {
//       document.getElementById('currentImage').src = decodeURIComponent(imageSrc); // แสดงผลรูปภาพใน what-cheese2
//     }
// });
