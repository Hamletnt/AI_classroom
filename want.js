...
const dropdownData = {
  family: ['a','Cheddar', 'Feta', 'Blue', 'Swiss Cheese', 'Gouda', 'Mozzarella', 'Cottage', 'Tomme', 'Brie', 'Parmesan', 'Camembert', 'Monterey Jack', 'Pasta filata', 'Caciotta', 'Pecorino', 'Gorgonzola', 'Raclette', 'Cornish', 'Havarti', 'Italian Cheese', 'Saint-Paul'],
...
// ฟังก์ชันในการเปลี่ยนค่าว่างเป็น null
const formatData = (obj) => {
  return Object.values(obj).map(value => (value.length > 0 ? value[0] : null));
};
